...
import heroIllustration from "../assets/Gemini_Generated_Image_jlix6fjlix6fjlix (1) 1 (1).png";
import heroIllustrationDesktop from "../assets/hero-illustration.png";
      ...
      <div className="library-hero-card">
        <div className="library-hero-content">
          <div className="library-hero-text">
            <h1 className="libary-hero-title text-4xl font-serif font-bold">
              Your Library
            </h1>
